		...
		if(objectId!=undefined && objectId!=''){
		    ...
		    if (headerLayout == null) {
		    	...
		    	if(pageCode=='LOGIN' || pageCode=='EMAILRECEIVECANCEL'){
					...
					headerLayout.innerHTML += "				<li class='first_child'><a href='"+location.protocol+"//www.melon.com/chart/index.htm' class='main_menu menu01' title='멜론차트'><span>멜론차트</span></a></li>";
					headerLayout.innerHTML += "				<li class=''><a href='"+location.protocol+"//www.melon.com/new/index.htm' class='main_menu menu02' title='최신음악'><span>최신음악</span></a></li>";
					headerLayout.innerHTML += "				<li class=''><a href='"+location.protocol+"//www.melon.com/genre/song_list.htm?classicMenuId=DP0100' class='main_menu menu03' title='장르음악'><span>장르음악</span></a></li>";
					headerLayout.innerHTML += "				<li class=''><a href='"+location.protocol+"//www.melon.com/dj/today/djtoday_list.htm' class='main_menu menu04' title='멜론DJ'><span>멜론DJ</span></a></li>";
					headerLayout.innerHTML += "				<li class=''><a href='"+location.protocol+"//www.melon.com/tv/index.htm' class='main_menu menu05' title='멜론TV'><span>멜론TV</span></a></li>";
					headerLayout.innerHTML += "				<li class=''><a href='"+location.protocol+"//www.melon.com/artistplus/todayupdate/index.htm' class='main_menu menu06' title='스타포스트'><span>스타포스트</span></a></li>";
					headerLayout.innerHTML += "				<li class=''><a href='"+location.protocol+"//www.melon.com/musicstory/today/index.htm' class='main_menu menu07' title='뮤직스토리'><span>뮤직스토리</span></a></li>";
					...
					headerLayout.innerHTML += "						<ul>";
					headerLayout.innerHTML += "							<li class=''><a href='"+location.protocol+"//www.melon.com/smartradio/index.htm' title='스마트라디오'><span class='menu_more m1'>스마트라디오</span></a></li>";
					headerLayout.innerHTML += "							<li class=''><a href='"+location.protocol+"//www.melon.com/flac/index.htm' title='원음전용관'><span class='menu_more m2'>원음전용관</span></a></li>";
					headerLayout.innerHTML += "							<li class=''><a href='"+location.protocol+"//www.melon.com/edu/index.htm' title='어학'><span class='menu_more m3'>어학</span></a></li>";
					headerLayout.innerHTML += "							<li class=''><a href='"+location.protocol+"//www.melon.com/customer/announce/index.htm' title='공지사항'><span class='menu_more m4'>공지사항</span></a></li>";
					headerLayout.innerHTML += "						</ul>";
					headerLayout.innerHTML += "						<ul>";
					headerLayout.innerHTML += "							<li class=''><a href='"+location.protocol+"//www.melon.com/commerce/pamphlet/web/sale_listMainView.htm' title='이용권구매'><span class='menu_more m9'>이용권구매</span></a></li>";
					headerLayout.innerHTML += "							<li class=''><a href='javascript:goMyPageAddCash();' title='멜론캐쉬충전'><span class='menu_more m6'>멜론캐쉬충전</span></a></li>";
					headerLayout.innerHTML += "							<li class=''><a href='"+location.protocol+"//www.melon.com/event/index.htm' title='이벤트'><span class='menu_more m7'>이벤트</span></a></li>";
			...
			document.write("								<a href='"+location.protocol+"//www.melon.com/chart/index.htm' class='menu01' title='멜론차트'>멜론차트</a>");
			document.write("							</li>");
			document.write("							<li class=''>");
			document.write("								<a href='"+location.protocol+"//www.melon.com/new/index.htm' class='menu02' title='최신'>최신</a>");
			document.write("							</li>");
			document.write("							<li class=''>");
			document.write("								<a href='"+location.protocol+"//www.melon.com/genre/song_list.htm?classicMenuId=DP0100' class='menu03' title='장르음악'>장르</a>");
			document.write("							</li>");
			document.write("							<li class=''>");
			document.write("								<a href='"+location.protocol+"//www.melon.com/dj/today/djtoday_list.htm' class='menu04' title='멜론DJ'>멜론DJ</a>");
			document.write("							</li>");
			document.write("							<li class=''>");
			document.write("								<a href='"+location.protocol+"//www.melon.com/tv/index.htm' class='menu05' title='멜론TV'>멜론TV</a>");
			document.write("							</li>");
			document.write("							<li class=''>");
			document.write("								<a href='"+location.protocol+"//www.melon.com/artistplus/todayupdate/index.htm' class='menu06' title='스타포스트'>스타포스트</a>");
			document.write("							</li>");
			document.write("							<li class=''>");
			document.write("								<a href='"+location.protocol+"//www.melon.com/musicstory/today/index.htm' class='menu07' title='매거진'>매거진</a>");
			document.write("							</li>");
			document.write("							<li class=''>");
			document.write("								<a href='"+location.protocol+"//www.melon.com/melonaward/timeline.htm' class='menu08' title='뮤직어워드'>뮤직어워드</a>");
			document.write("							</li>");
			document.write("							<li class=''>");
			document.write("								<a href='"+location.protocol+"//www.melon.com/flac/index.htm' class='menu09' title='멜론Hi-Fi'>멜론Hi-Fi</a>");
			document.write("							</li>");
			document.write("						</ul>");
			document.write("					</div>");
			document.write("				</div>");
...
//			document.write("			</ul>");
			...
			document.write("				<li class='menu05'><a title='멜론4.0 둘러보기 - 페이지 이동' href='"+location.protocol+"//www.melon.com/serviceintro/index.htm'><span>멜론4.0 둘러보기</span></a></li>");
			document.write("				<li class='menu06'><a title='Windows 플레이어 - 페이지 이동' href='"+location.protocol+"//www.melon.com/customer/serviceintro/index.htm'><span>Windows 플레이어</span></a></li>");
			document.write("				<li class='menu07'><a title='Mac 플레이어 - 페이지 이동'  href='"+location.protocol+"//www.melon.com/customer/serviceintro/multi_pc_web.htm'><span>Mac 플레이어</span></a></li>");
			document.write("				<li class='menu09'><a title='iPad - 페이지 이동'  href='"+location.protocol+"//www.melon.com/customer/serviceintro/ipad.htm'><span>iPad</span><span class='icon_new'></span></a></li>");
			...
			document.write("			<li><a href='"+location.protocol+"//info.melon.com/terms/web/terms1_1.html' title='이용약관 ' target='_blank'>이용약관</a></li>");
			document.write("			<li><a href='"+location.protocol+"//info.melon.com/terms/web/terms3.html' title='개인정보처리방침 ' target='_blank'><strong>개인정보처리방침</strong></a></li>");
			document.write("			<li><a href='"+location.protocol+"//info.melon.com/terms/web/terms5_1.html' title='청소년보호정책 ' target='_blank'>청소년보호정책</a></li>");
			...
			document.write("			<li><a href='"+location.protocol+"//partner.melon.com' title='파트너센터 ' target='_blank'>파트너센터</a></li>");
			...
			document.write("		</ul>");
			document.write("		<p>");
			document.write('			<span class="first">(주) 카카오 M</span><span>서울시 강남구 테헤란로 103길 17</span><span>대표이사 : 이제욱</span><span>사업자등록번호 : 138-81-05876</span><span>통신판매업 신고번호 : 제2011-서울강남-02008호</span><br /><span class="first">문의전화(평일 09:00~18:00) : 1566-7727 (유료)</span><span>이메일 : <a href="https://helpdesk.melon.com/customer/help/helpForm.htm?type=" class="btn_footer_mail" title="1:1문의하기" target="_blank">meloninformation@kakao-m.com</a></span><span>호스팅 제공자 : (주) 카카오 M</span><span>© Kakao M Corp.All rights reserved.</span>');
			document.write("		</p>");
			document.write("		<div class='ban'>");
			document.write('			<a href="https://www.melon.com/footer/awrad.htm?pageType=06"><img src="https://cdnimg.melon.co.kr/resource/image/web/common/ban_footer_design_2018.png" width="52" height="26" alt="Design Award 2018" /></a>');
			document.write('			<a href="https://www.melon.com/footer/awrad.htm?pageType=06"><img src="https://cdnimg.melon.co.kr/resource/image/web/common/ban_footer_reddot_2017.png" width="101" height="25" alt="reddot award 2017" /></a>');
			document.write('			<a href="https://www.melon.com/footer/awrad.htm?pageType=02"><img src="https://cdnimg.melon.co.kr/resource/image/web/common/ban_footer01_20180125.png" width="102" height="25" alt="2018 대한민국 퍼스트브랜드 대상" /></a>');
			document.write('			<a href="https://www.melon.com/footer/awrad.htm?pageType=04"><img src="https://cdnimg.melon.co.kr/resource/image/web/common/ban_footer04_20180125.png" width="128" height="25" alt="2018 소비자가 뽑은 가장 신뢰하는 브랜드 대상" /></a>');
			document.write('			<a href="https://www.melon.com/footer/awrad.htm?pageType=03"><img src="https://cdnimg.melon.co.kr/resource/image/web/common/ban_footer02_20180406.png" width="114" height="25" alt="한국능률협회컨설팅 2018 브랜드 파워 1위" /></a>');
			document.write('			<a href="http://www.kdce.or.kr/user/ctf/clmsCtfTransList.do?NmberBusiRegNo=1388105876&websiteName=www.melon.com&SUB=FB"><img src="https://cdnimg.melon.co.kr/resource/image/web/common/ban_footer06_161209.png" width="82" height="25" alt="음악저작권 이용허락 인증" /></a>');
			document.write('			<a href="https://www.copyrightok.kr"><img src="https://cdnimg.melon.co.kr/resource/image/web/common/ban_footer07_20180618.png" width="67" height="25" alt="저작권OK" /></a>');
			document.write('			<a class="last_child" href="http://isms.kisa.or.kr/"><img src="https://cdnimg.melon.co.kr/resource/image/web/common/ban_footer09_161209.png" width="102" height="25" alt="정보보호 관리체계 ISMS 인증" /></a>');
			document.write("		</div>");
			document.write("	</div>");
